...
function getData() {
  fetch(
    "https://allforonecmartinez.azurewebsites.net/AddingNumbers/" + input1.value + "/" + input2.value
  )
...
// function getData() {
//   fetch("https://allforonecmartinez.azurewebsites.net/AddingNumbers/1976/8888")
//     .then(
